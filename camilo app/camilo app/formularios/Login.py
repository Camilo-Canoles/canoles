...
from formularios.PAdmin import *
...
class Login(tk.Tk):
    ...
    def __init__(self):
        ...
        self.logo = utl.leer_imagen(r"camilo app/imagenes/logo.png", (300, 100))
        self.user = utl.leer_imagen(r"camilo app/imagenes/login.png", (64, 64))
    ...
    def validar(self):
        with open("D:/camilo app/camilo app/db_users.json", "r", encoding='utf-8') as file:
